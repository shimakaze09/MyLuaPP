...
template <>
struct My::MySRefl::TypeInfo<Buffer> : My::MySRefl::TypeInfoBase<Buffer> {
  ...
  static constexpr FieldList fields = {
      ...
      Field{"InitTable",
            static_cast<void (Buffer::*)(size_t)>(&Buffer::InitTable),
            AttrList{
                Attr{MY_MYSREFL_NAME_ARG(0),
                     AttrList{
                         Attr{Name::name, "offset"},
      ...
      Field{
          "InitTable",
          static_cast<void (Buffer::*)(size_t, sol::table)>(&Buffer::InitTable),
          AttrList{
              Attr{MY_MYSREFL_NAME_ARG(0),
                   AttrList{
                       Attr{Name::name, "offset"},
