...
struct Point {
  ...
  Point AddPointer(const Point* rhs) const { return {x + rhs->x, y + rhs->y}; }

  Point* This() { return this; }

  void* ThisVoid() { return this; }

  Point AddPointer2(Point rhs) const { return {x + rhs.x, y + rhs.y}; }

  static void Print(Point* p) { cout << p << endl; }
  ...
  static void Print3(A* p) { cout << p << endl; }
};
