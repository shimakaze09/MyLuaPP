...
template <>
struct My::MySRefl::TypeInfo<Var> : TypeInfoBase<Var> {
  ...
  static constexpr FieldList fields = {
      ...
      Field{TSTR("const_v"), &Type::const_v,
            AttrList{
                Attr{TSTR(MyMeta::initializer),
                     []() -> const int {
                       return 1;
      ...
      Field{TSTR("static_v"), &Type::static_v,
            AttrList{
                Attr{TSTR(MyMeta::initializer),
                     []() -> int {
                       return 2;
      ...
      Field{TSTR("static_const_v"), &Type::static_const_v,
            AttrList{
                Attr{TSTR(MyMeta::initializer),
                     []() -> const int {
                       return 3;
